...
<div class="pic-color-grid">
<img src="%base_url%/assets/img/report/cdon.png" alt="cdon-front-page">
<h3 class="colors-h3">Färger:</h3>
<p class="cdon-greenlogo"> #01C355 </p>
<p class="cdon-darkgreen"> #2FC356 </p>
<p class="cdon-black"> #17242F </p>
<p class="cdon-grey"> #F7F7F6 </p>
<p class="cdon-pink"> #FD0172 Accentfärg</p>
<h3 class="font-h3">Typsnitt: <br> h1/brödtext</h3>
<p class="cdon-font"> Cdon Inter,-apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif <br>Använder enbart Sans-serif </p>
<h3 class="color-scheme"> Färgschema: </h3>
<p class="actual-color-scheme"> Komplementärt </p>
</div>
<br> <br>
...
<div class="pic-color-grid">
<img src="%base_url%/assets/img/report/fyndiq.png" alt="fyndiq-front-page">
<h3 class="colors-h3">Färger:</h3>
<p class="fyndiq-pinklogo"> #EA4E68 Logo/Accentfärg</p>
<p class="fyndiq-darkblue"> #003B4D </p>
<p class="fyndiq-red"> #922024 </p>
<p class="fyndiq-purple"> #8F43D6 På en slide</p>
<p class="fyndiq-blue"> #0073BB Accentfärg</p>
<p class="fyndiq-light-blue"> #0073BB Orginalfärg, Accentfärg</p>
<h3 class="font-h3">Typsnitt: <br> h4/h2/<br>brödtext</h3>
<p class="fyndiq-font"> Mulish, Helvetica Neue, Helvetica, Roboto, sans-serif <br> Använder enbart Sans-serif </p>
<h3 class="color-scheme"> Färgschema: </h3>
<p class="actual-color-scheme"> Monokromatiskt </p>
</div>
<br>

<h2 style="padding-top: 2.8em" >Analys</h2>

Observera att delar eller hela analysen har utgått från startsidan/första intrycket. Jag är medveten om att exempelvis Fyndiq ändrar från röd till sin vanliga ljusblåa färg om man bläddrar lite längre in på sidan men jag har valt att utgå ifrån dem lite mer tidsenliga färgvalen vissa sidor valt under julsäsongen.

<h4>&nbsp;&nbsp; Amazon</h4>
Amazons färger är header och navbar-färger är en typ av nästan svart(#131921) samt en mörk gråblå (#232F3E). Dem använder även en orange(#FF9900) accentfärg för att sätta ton på sin logga 
samt för visa antal produkter i kundvagnen. Som besökare av hemsidan upplever jag att den orangea accentfärgen tydligt drar ögonen till dessa två viktiga funktioner. Det används även ytterligare 
två toner av orange färg, dels till sökknappen samt när man börjar klicka sig vidare bland produkterna för att markera populära produkter med #1 och #2 osv. Jag upplever att Amazon gör ett ganska bra jobb med att dra ögonen till dem mest intressanta funktionerna på sidan. Trologtvis är kontrasten mellan dem mörka färgerna samt den orangea ett genomtänkt sätt att utnyttja att 
människans ögon dras till ljus.  En blåaktig bakrundsbild bryter av med en vit(#FFFFFF) 'färg' längre ner. Klickar man sig vidare på Amazon eller bläddrar nedåt så tappar sidan snart sitt varma motagande och blir allt med basic och ger känslan av gulblekta extraprisskyltar. Med trånga menyer samt 'kladdiga' annonser innehållande bilder med klumpigt placerade priser och ibland, onödig information (Med onödig information avses exempelvis saker som hör hemma i produktbeskrivningen när man väl klickat in på annonsen, som längd, bredd och höjd) så blir sidan snabbt ointressant och generisk. Då hamnar fokuset troligtvis mer på att visa och sälja produkter för användaren, vilket såklart är deras slutliga mål. Amazons färgtema är komplementärt med några 
justeringar på den orangea färgen.
Amazon använder främst sin egna font, Amazon Ember, som är en sans-serif font vilket jag upplever som en mer avslappnad font än om det hade varit en serif. Det känns som ett rimligt font-val då 
sidan redan är ganska fyrkantig i sin design och därmed ger fonten lite rundare känsla. 
